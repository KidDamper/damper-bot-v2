...
export function brainSessionReward(question,correct){return brainReward(question?.difficulty||question?.d,correct);}
...
export function sessionResult(type,{won=false,difficulty=null,ms=null,falseStart=false}={}){
  if(type==='BRAIN')return brainSessionReward({difficulty:difficulty||'EASY'},won);
